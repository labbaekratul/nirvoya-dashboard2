                ...
                <div className="col-md-12 bg-white rounded-3 shadow-lg p-4">
                  <div className="d-flex justify-content-between mb-4">
                    <form className="d-flex formStyle">
                      <div>
                        <input type="text" value={orderSearch} onChange={(e) => setOrderSearch(e.target.value)} style={{ width: 300 }} className="form-control" placeholder="Search..." />
                      </div>
                          ...
                          return (
                            <tr>                              
                              ...
                              <td>
                                ...
                                <button className="adminBtnButton" type="button" onClick={() => deleteHandler(order._id)}>
